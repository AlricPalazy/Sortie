...
activities = {
    "fr": [
        ("Cathédrale de Strasbourg", "https://www.visitstrasbourg.fr/en/fiche-sit/F223007269_the-cathedral-of-notre-dame-strasbourg/"),
        ("Balade en bateau - Batorama", "https://www.batorama.com"),
        ("Quartier de la Petite France", "https://www.visit.alsace/223007616-la-petite-france/")
    ],
    "en": [
        ("Strasbourg Cathedral", "https://www.visitstrasbourg.fr/en/fiche-sit/F223007269_the-cathedral-of-notre-dame-strasbourg/"),
        ("Boat Tour - Batorama", "https://www.batorama.com"),
        ("La Petite France District", "https://www.visit.alsace/223007616-la-petite-france/")
    ]
}
...
def show_recommendations():
    ...
    if lang == "fr":
        ...
        transport = "Tram or bus 🚋" if data['rain'] else "Bike or walk 🚴" if data['temp'] > 25 else "Any transport 🚶‍♂️🚋"
    ...
    if data['rain']:
        ...
        for name, url in activities[lang]:
            ttk.Button(result_frame, text=name, command=lambda u=url: open_url(u)).pack(anchor="w", padx=10, pady=2)
